...
<div class="header bg-main">
    ...
    <div class="head-l"> <a href="##" class="button button-little bg-blue"><span class="icon-wrench"></span> Clear cache</a> &nbsp;&nbsp;<a class="button button-little bg-red" href="../../register.jsp"><span class="icon-power-off"></span> 退出登录</a> </div>
</div>
<div class="leftnav">
...
<ul class="bread">
    ...
    <li><b>Current language：</b><span style="color:red;">chinese</span>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;switch language：<a href="<%=path%>WEB-INF/user/studentIndex.jsp">Chinese</a> &nbsp;&nbsp;<a href="<%=path%>WEB-INF/user/studentIndex-EN.jsp">English</a> </li>
</ul>
<div class="admin">
